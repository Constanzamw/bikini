...
import {  getUserById,  getUserInformation,  logOut,} from "../redux/features/user/userActions.js";

import {  RiMailLine,  RiLockLine,  RiEyeLine,  RiEyeOffLine,  RiGoogleFill,  RiReplyLine,} from "react-icons/ri";
//import { forgetPass } from "../utils/resetPassword.js"; VEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEERRRR
...
const Login = () => {
  ...
  useEffect(() => {
    if (user.userType) {
    if (user.userType == "customer") router.replace("/auth")
    if (user.userType == "admin") router.replace("/auth")
    }
  }, [user]);
